...
parser.add_argument("-m", "--mode", type=str, metavar='', default="train, pr, ex, or best")
...
parser.add_argument("-h", "--hparams", type=str, metavar='', help="A comma-separated list of `name=value` hyperparameter values. This flag "
...
parser.add_argument("-nf", "--netvlad_feat", type=str, default=None, help="Binary base file for NetVLAD features. If you did this for dataset XX, "
                               "the program will look for XX_db.bin and XX_q.bin" )
parser.add_argument("-i", "--input_dir", type=str, metavar='', default="mnt/coco/calc_tfrecords/", help="tfrecords dir")
...
parser.add_argument("-if", "--image_fl", metavar='')
